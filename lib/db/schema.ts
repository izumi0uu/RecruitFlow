...
export const workspaceRoleValues = ['owner', 'recruiter', 'coordinator'] as const;
export const clientStatusValues = ['active', 'prospect', 'paused', 'archived'] as const;
export const clientPriorityValues = ['low', 'medium', 'high'] as const;
export const jobStatusValues = ['intake', 'open', 'on_hold', 'closed', 'filled'] as const;
...
export const documentTypeValues = ['jd', 'resume', 'call_note', 'interview_note'] as const;
...
export const automationStatusValues = ['queued', 'running', 'succeeded', 'failed'] as const;
...
export const clientPriorityEnum = pgEnum('client_priority', clientPriorityValues);
...
export const submissionStageEnum = pgEnum('submission_stage', submissionStageValues);
...
export const automationTypeEnum = pgEnum('automation_type', automationTypeValues);
export const automationStatusEnum = pgEnum('automation_status', automationStatusValues);
...
export const documents = pgTable('documents', {
  ...
  summaryStatus: automationStatusEnum('summary_status').notNull().default('queued'),
  summaryText: text('summary_text'),
  embeddingStatus: automationStatusEnum('embedding_status').notNull().default('queued'),
  ...timestamps(),
});
