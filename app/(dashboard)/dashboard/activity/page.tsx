...
const ActivityPage = async () => {
    ...
    return (<section className="flex-1 p-4 lg:p-8">
      ...
      <Card>
        ...
        <CardContent>
          {logs.length > 0 ? (<ul className="space-y-4">
              {logs.map((log) => {
                const Icon = iconMap[log.action as ActivityType] || Settings;
                const formattedAction = formatAction(log.action as ActivityType);
                return (<li key={log.id} className="flex items-center space-x-4">
            ...
            </ul>) : (<div className="flex flex-col items-center justify-center text-center py-12">
